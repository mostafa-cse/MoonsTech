        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaxDiscountCap = table.Column<decimal>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MegaCoinReward = table.Column<int>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    PcBuildId = table.Column<Guid>(type: "TEXT", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PcBuildComponents_Products_ProductId",
            ...
            migrationBuilder.CreateTable(
                name: "DeliveryVerifications",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    OrderId = table.Column<Guid>(type: "TEXT", nullable: false),
                    OtpCode = table.Column<string>(type: "TEXT", nullable: false),
                    OtpExpiresAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    SignatureImageUrl = table.Column<string>(type: "TEXT", nullable: false),
                    DeliveryPhotoUrl = table.Column<string>(type: "TEXT", nullable: false),
                    VerifiedAt = table.Column<DateTime>(type: "TEXT", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DeliveryVerifications", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DeliveryVerifications_Orders_OrderId",
                        column: x => x.OrderId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MegaCoinLedgers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MegaCoinLedgers_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MegaCoinLedgers_Orders_OrderId",
                        column: x => x.OrderId,
                        principalTable: "Orders",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DeliveryVerifications_OrderId",
                table: "DeliveryVerifications",
                column: "OrderId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_MegaCoinLedgers_OrderId",
                table: "MegaCoinLedgers",
                column: "OrderId");

            migrationBuilder.CreateIndex(
                name: "IX_MegaCoinLedgers_UserId_CreatedAt",
                table: "MegaCoinLedgers",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PcBuildComponents_ProductId",
                table: "PcBuildComponents",
                column: "ProductId");
